...
#CMD sleep infinity
CMD python Motion_Deblurring/test.py --input_dir /opt/restormer/images/degraded --result_dir /opt/restormer/images/restored \
--weights /opt/restormer/models/single_image_defocus_deblurring.pth --original_dir /opt/restormer/images/originals
